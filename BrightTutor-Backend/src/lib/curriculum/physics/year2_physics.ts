/**
 * Year 2 Physics Curriculum - Mauritanie
 * Chapters 1-3: États de la Matière, Mélanges, Circuits Électriques
 */

export const YEAR2_PHYSICS_CURRICULUM = {
  year: 2,
  subject: 'Physique',
  title: 'Manuel de Physique-Chimie 2e AS (Deuxième Année Secondaire) - Mauritanie',
...
export default YEAR2_PHYSICS_CURRICULUM;
