...
export const BAC_C_LOGARITHMES: CurriculumSection = {
...
6. Faire pratiquer les techniques de calcul avancées (limites complexes, dérivées composées, primitives par parties)
7. Illustrer avec des exemples complexes et progressifs
