...
export const BAC_C_CALCUL_INTEGRAL: CurriculumSection = {
          id: 'bac-2023-calcul-integral',
          title: 'Calcul intégral',
          description: 'Calcul intégral complet: notion d\'intégrale, primitives, interprétation géométrique (aire), propriétés, fonctions paires/impaires/périodiques, techniques de calcul (changement de variable, intégration par parties), approximation, volumes de révolution. 8 modules progressifs.',
          concepts: [
...
On considère plusieurs problèmes sur le calcul intégral.
...
5. Insister sur les techniques de calcul avancées (changement de variable complexe, intégration par parties multiples)
6. Faire pratiquer les méthodes standards avec des fonctions complexes
7. Illustrer géométriquement chaque notion
8. Intégrer les techniques des exercices corrigés dans les questions générées
9. Générer des exercices de niveau DIFFICILE/TRÈS DIFFICILE (pas faciles comme Bac D)
...
12. **Astuces :** Toujours vérifier une primitive en la dérivant. Pour l'intégration par parties, choisir u qui se simplifie. Pour les symétries, vérifier d'abord si la fonction est paire/impaire.`,
          ...
          // Niveau adapté au Bac C : exercices TRÈS DIFFICILES (plus difficiles que Bac D)
          exercises: [],
