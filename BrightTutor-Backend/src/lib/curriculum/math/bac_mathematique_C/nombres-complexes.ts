...
export const BAC_C_NOMBRES_COMPLEXES: CurriculumSection = {
  id: 'bac-2023-ex3',
  title: 'Nombres complexes',
  description: 'Nombres complexes complets: carte mentale, plan complexe et affixe, opérations, conjugué, module et distance, coordonnées polaires, argument, forme exponentielle, puissances (Moivre), racines, équations du second degré, géométrie complexe, transformations. 13 modules progressifs.',
          concepts: [
    'Nombres complexes',
    'Plan complexe',
    'Affixe d\'un point',
  ...
  objectives: [
    ...
    'Utiliser les transformations complexes (translation, rotation, affinité)'
  ],
  content: {
    enonce_complet: `**EXERCICE TYPE BAC - NOMBRES COMPLEXES COMPLETS**

On considère plusieurs problèmes sur les nombres complexes.
...
**PARTIE IV - GÉOMÉTRIE ET TRANSFORMATIONS (Modules 11-12)**
12. Géométrie complexe: lieux et quotients.
13. Transformations (niveau bac): translation, rotation, affinité.`,
...
7. Illustrer géométriquement chaque notion`,
    modules: {
      ...
      module_12: {
        titre: 'Transformations (niveau bac)',
        notion: 'Transformations géométriques via nombres complexes',
        contenu: {
          translation: 'z\' = z + a',
          rotation_centre_O: 'z\' = e^(iα) z',
          affinite_simple: 'z\' = e^(iα) z + a',
          interpretation: 'Interprétation géométrique + construction',
          illustration: 'Exemples de transformations'
        }
      }
    }
  },
