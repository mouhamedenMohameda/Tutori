...
/**
 * Parse pagination from Express req.query (for API routes)
 */
export function parsePaginationFromExpress(query: Record<string, unknown>): { page: number; limit: number; skip: number } {
