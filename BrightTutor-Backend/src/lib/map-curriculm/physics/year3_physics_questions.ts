/**
 * Year 3 Physics - Questions for Each Section
 * All questions are verifiable and appropriate for app format
 * Note: Year 3 Physics uses the same program as Year 2 Physics
 */

export const YEAR3_PHYSICS_SECTION_QUESTIONS: {
  [sectionId: string]: {
...
export default YEAR3_PHYSICS_SECTION_QUESTIONS;
